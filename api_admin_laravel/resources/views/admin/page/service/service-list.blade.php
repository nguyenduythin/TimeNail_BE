                            ...
                            <form method="POST" action="{{route('service.add.api')}}" class="add-new-user modal-content pt-0" enctype="multipart/form-data">
                                ...
                                <div class="modal-body flex-grow-1">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" data-type="currency" class="form-control dt-full-name" id="basic-icon-default-price" placeholder="100,000₫" name="price" />
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-icon-default-time">Tổng Thời Gian (phút)</label>
                                        <input type="text" class="form-control dt-full-name" id="basic-icon-default-time" name="total_time_work" />
                                    </div>
                                    <div class="mb-1">
